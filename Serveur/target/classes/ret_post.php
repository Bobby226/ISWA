...
<div class="bg" data-vide-bg="video/laptop">
    <div class="center-container">
        <h1 class="agile-head text-center">Bravo !</h1>
        <div class="container">
            <div class="form_w3layouts">
                ...
                <form action="#" method="post" class="w3_agile_login">
                    <div class="w3_agile_login">
                        <input type="button" name="tamer" value="Consulter son profil" onclick="self.location.href='http://tamer:4242/Profil.html'">
                    </div>
                </form>
            </div>
        </div>
